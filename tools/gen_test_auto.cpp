...
int main() {
    ...
    std::ofstream of_everything("test/auto/prog.kasm");
    of_everything << "# WARNING: THIS TEST IS AUTOGENERATED, DO NOT EDIT OR DELETE" << std::endl
                  << "# generated by tools/gen_test_auto.cpp" << std::endl
                  << "#" << std::endl
                  << "# run_everything (mostly, except jumps and io)" << std::endl
                  << std::endl
