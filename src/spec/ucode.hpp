...
// This: GCTRL_ACTION_RIP_BUSA_O is RETIRED, can be computed by ANDing the low bit of UC with the value of CBIT_INSTMASK
...
#define MCTRL_USE_PREFIX_FAR (1ULL << (0 + MCTRL_BASE))
#define MCTRL_PREFIX_STORE   (1ULL << (1 + MCTRL_BASE))
#define MCTRL_N_MAIN_OUT     (1ULL << (2 + MCTRL_BASE))
#define MCTRL_MAIN_STORE     (1ULL << (3 + MCTRL_BASE))
#define MCTRL_FIDD_STORE     (1ULL << (4 + MCTRL_BASE))
#define MCTRL_N_FIDD_OUT     (1ULL << (5 + MCTRL_BASE))
// HARDWARE NOTE JUMPER ---- MCTRL_BIOS_WRITE
#define MCTRL_BUSMODE_WRITE  (1ULL << (6 + MCTRL_BASE))
#define MCTRL_BUSMODE_X      (1ULL << (7 + MCTRL_BASE))

// #define OFF_MCTRL_BUSMODE
#define MASK_MCTRL_BUSMODE (0b111ULL << (8 + MCTRL_BASE))
// #define MCTRL_BUSMODE (8 + MCTRL_BASE)
#define MCTRL_BUSMODE_NONE                (0ULL << (8 + MCTRL_BASE))
#define MCTRL_BUSMODE_CONH                (1ULL << (8 + MCTRL_BASE))
#define MCTRL_BUSMODE_CONW_BUSM           (2ULL << (8 + MCTRL_BASE))
#define MCTRL_BUSMODE_CONW_BUSB           (3ULL << (8 + MCTRL_BASE))
#define MCTRL_BUSMODE_CONW_BUSB_MAYBEFLIP (4ULL << (8 + MCTRL_BASE))
